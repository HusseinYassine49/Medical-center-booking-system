...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha512-Ac8f+zA4lZz+IEd4R5UaVre1Ne4s5jAp9k8wEq/mh4CO5FExFj8aH1scw5fSbE1sh1LzG2eCphH7jIZt0Gx42w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body>
    ...
    <div class="add-department" id="add-department">
      ...
      <form id="departmentForm">
        ...
        <div class="input-row">
          <div class="input-group">
            <label>Icon</label>
            <input type="text" id="department-icon" name="icon" required />
            <!-- Optionally, you can add an icon preview here if needed -->
          </div>
        </div>
        ...
        <table class="tbl" id="filter">
          <thead>
            <tr>
              ...
              <th>Department</th>
              <th>Description</th>
              <th>Icon</th> <!-- New column for Icon -->
  ...
  <script src="js/deleteDEP-AJAX.js"></script>
