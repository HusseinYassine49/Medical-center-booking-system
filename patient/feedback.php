            ...
            <div class="card-body">
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h6 class="mb-2 text-primary"> Feedback</h6>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label for="fullName">Select Doctor</label>
                            <select class="form-control" id="doctor" name="doctor" required
                                onchange="fetchDoctorAvailability()">
                                <option value="" disabled selected>Select Doctor</option>
                                <?php while ($row = $doctorsResult->fetch_assoc()) : ?>
                                <option value="<?= $row['DoctorID'] ?>"><?= $row['Fname'] ?> <?= $row['Lname'] ?>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.forEach(function(doctor) {
                    doctorSelect.append('<option value="' + doctor.DoctorID + '">' + doctor
                        .Fname + ' ' + doctor.Lname + '</option>');
                });
            }
        });
    }
