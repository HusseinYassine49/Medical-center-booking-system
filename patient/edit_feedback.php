...
// Fetch feedback data
$queryf = "SELECT * FROM feedback WHERE id=$ID";
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="comment" name="comment"
                                    placeholder="Enter your comment" value="<?= $rowf['comment'] ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                ...
                success: function(response) {
                    if (response = 'success') {
                        Swal.fire({
                            ...
                            window.location.href = 'feedback.php?userid=' + response
                                .userid;
                        });
                    } else {
                        Swal.fire({
